//
//  NavigationControllerHentaiNeko.swift
//  newbiezone
//
...
class NavigationControllerHentaiNeko: UINavigationController {

    override func viewDidLoad() {
        super.viewDidLoad()
        
        var storyboardKanban: UIStoryboard
        storyboardKanban = UIStoryboard.init(name: "HentaiNeko", bundle: nil)
        
        var tabelViewControllerHentaiNeko: TableViewControllerHentaiNeko
